...
Generated at: 2026-03-13T02:13:55.286383+00:00
Project: shop-0312-user
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/",
        "method": "GET",
        "description": "Verify health check returns status healthy and service name",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    },
    {
        ...
        "request_data": {
            ...
            "query": {},
            "body": {
                "email": "alice-create-hp@example.com",
                "name": "Alice Smith"
            }
        },
        "expected_status": 200,
        ...
        "actual_response": {
            ...
            "id": 4,
            "name": "Alice Smith",
            "created_at": "2026-03-13T02:01:01.633330"
        }
    },
    {
        ...
        "setup": {
            ...
            "method": "POST",
            "body": {
                "email": "duplicate-test-dup@example.com",
                "name": "First User"
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without required fields, expect 500 due to SQLModel table model passing validation but failing at DB level",
        "request_data": {
            "path": {},
            "query": {},
            "body": {}
        ...
        "actual_response": [
            {
                ...
                "id": 1,
                "name": "Alice Smith",
                "created_at": "2026-03-13T01:58:18.300861"
            },
            {
                "email": "duplicate@example.com",
                "id": 2,
                "name": "First User",
                "created_at": "2026-03-13T01:58:18.320866"
            },
            {
                "email": "getbyid@example.com",
                "id": 3,
                "name": "Get By Id User",
                "created_at": "2026-03-13T01:58:18.403891"
            },
            {
                "email": "alice-create-hp@example.com",
                "id": 4,
            ...
            },
            {
                ...
                "id": 5,
                "name": "First User",
                "created_at": "2026-03-13T02:01:01.656827"
            }
        ]
    },
    {
        ...
        "actual_response": {
            ...
            "id": 6,
            "name": "Get By Id User",
            "created_at": "2026-03-13T02:01:01.690900"
        }
    },
    {
        ...
        "endpoint": "/users/{user_id}",
        "method": "GET",
        "description": "Attempt to get a user with a non-existent ID, expect 404",
        "request_data": {
            "path": {
                "user_id": 999999
            },
