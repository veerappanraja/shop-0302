...
Generated at: 2026-03-03T04:01:37.828459+00:00
Project: shop-0302
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "actual_response": {
            ...
            "email": "alice_v7_xk9m@example.com",
            "name": "Alice Johnson V7",
            "created_at": "2026-03-03T03:37:27.136541"
        }
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without the required email field, expect 500 (SQLModel table model does not raise 422)",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Attempt to create a user without the required name field, expect 500 (SQLModel table model does not raise 422)",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "actual_response": {
            ...
            "email": "getid_v7_hn4j@example.com",
            "name": "Get By Id User V7",
            "created_at": "2026-03-03T03:37:27.169804"
        }
    },
    {
    ...
    },
    {
        ...
        "actual_response": [
            ...
            },
            {
                ...
                "email": "dup_v7_qw3p@example.com",
                "name": "First User",
                "created_at": "2026-03-03T03:37:27.142461"
            },
            {
                "id": 3,
                "email": "getid_v7_hn4j@example.com",
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "Create a user then list all users to verify the created user appears",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
        ...
        "actual_response": [
            ...
            },
            {
                ...
                "email": "listchk_v7_yt8r@example.com",
                "name": "List Check User V7",
                "created_at": "2026-03-03T03:37:27.178472"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "GET",
        "description": "List all categories, expect a JSON array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Create a new product without a category, inventory auto-initialized",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
        ...
        "actual_response": {
            "id": 1,
            "price": "29.99",
            "created_at": "2026-03-03T03:37:27.191352",
            "category_id": null,
            "name": "Test Widget",
            "description": "A test product"
        }
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Attempt to create a product with a non-existent category, expect 404",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "actual_response": {
            "id": 2,
            "price": "15.50",
            "created_at": "2026-03-03T03:37:27.198248",
            "category_id": null,
            "name": "Get Product Test",
            "description": null
        }
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "GET",
        "description": "List all products, expect a JSON array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a product (auto-creates inventory) then get its inventory",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Inventory Check Product",
                "price": 10.0
            },
            "extract_id_from": "id"
        },
        ...
        "actual_response": {
            ...
            "reserved": 0,
            "product_id": 3,
            "last_updated": "2026-03-03T03:37:27.215641"
        }
    },
    {
    ...
    },
    {
        ...
        "actual_response": {
            ...
            "reserved": 0,
            "product_id": 4,
            "last_updated": "2026-03-03T03:37:27.228491"
        }
    },
    {
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a product (inventory=0) then try to reserve, expect 400 insufficient",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Reserve Fail Product",
                "price": 5.0
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/orders",
        "method": "GET",
        "description": "List all orders, expect a JSON array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Get the sales summary report",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Get the inventory summary report",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "inventory_report_with_threshold",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/inventory",
        "method": "GET",
    ...
    },
    {
        ...
        "actual_response": [
            {
                "category_id": 1,
                "category_name": "Electronics V7 Xk9m",
                "product_count": 0,
                "total_revenue": "0",
                "units_sold": 0
            }
    ...
    },
    {
        ...
        "actual_response": [
            {
                "user_id": 1,
                "user_name": "Alice Johnson V7",
                "user_email": "alice_v7_xk9m@example.com",
                "total_orders": 0,
                "total_spent": "0"
            },
            {
                ...
                "user_email": "dup_v7_qw3p@example.com",
                "total_orders": 0,
                "total_spent": "0"
            },
            {
                "user_id": 3,
                "user_name": "Get By Id User V7",
                "user_email": "getid_v7_hn4j@example.com",
                "total_orders": 0,
                "total_spent": "0"
            },
            {
                "user_id": 4,
                "user_name": "List Check User V7",
                "user_email": "listchk_v7_yt8r@example.com",
                "total_orders": 0,
                "total_spent": "0"
            }
        ]
