...
Generated at: 2026-03-03T03:48:42.279896+00:00
Project: shop-0302
Milestone: 4
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    {
        "name": "sales_report_with_order_data",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/sales",
        "method": "GET",
        "description": "Sales report after creating a user, category, product, updating inventory, and placing an order returns non-zero aggregations",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
    ...
    {
        "name": "inventory_report_empty_db_default_threshold",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/inventory",
        "method": "GET",
        "description": "Inventory report on empty database with default low_stock_threshold returns all zeros",
        "request_data": {
            "path": {},
            "query": {},
            "body": null
    ...
    {
        "name": "inventory_report_custom_threshold_zero",
        "category": "BOUNDARY",
        "endpoint": "/reports/inventory",
        "method": "GET",
        "description": "Inventory report with low_stock_threshold set to 0 on empty database",
        "request_data": {
            "path": {},
            "query": {
    ...
    {
        "name": "inventory_report_custom_threshold_high",
        "category": "BOUNDARY",
        "endpoint": "/reports/inventory",
        "method": "GET",
        "description": "Inventory report with a high low_stock_threshold value of 100",
        "request_data": {
            "path": {},
            "query": {
    ...
    {
        "name": "inventory_report_invalid_threshold_type",
        "category": "INVALID_TYPE",
        "endpoint": "/reports/inventory",
        "method": "GET",
        "description": "Inventory report with non-integer low_stock_threshold returns validation error",
        "request_data": {
            "path": {},
            "query": {
    ...
    },
    {
        ...
        "endpoint": "/reports/products",
        "method": "GET",
        "description": "Product performance report after creating a category and a product returns at least one result with expected fields",
        "setup": {
            "endpoint": "/categories",
            "method": "POST",
            "body": {
                "name": "Perf Test Category",
                "description": "Category for product performance test"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    {
        "name": "category_performance_with_category",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/categories",
        "method": "GET",
        "description": "Category performance report after creating a category returns at least one result with zero revenue and units sold",
        "setup": {
            "endpoint": "/categories",
            "method": "POST",
            "body": {
                "name": "CatPerf Test Category",
                "description": "Category for category performance test"
            },
            "extract_id_from": "id"
        },
        "request_data": {
    ...
    {
        "name": "user_activity_with_user",
        "category": "HAPPY_PATH",
        "endpoint": "/reports/users",
        "method": "GET",
        "description": "User activity report after creating a user returns at least one result showing the user with zero orders and zero spent",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
