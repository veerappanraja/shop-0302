...
Generated at: 2026-03-03T03:37:57.315856+00:00
Project: shop-0302
Milestone: 2
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "GET",
        "description": "List all categories, expects an array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Create a product with valid data and no category",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "GET",
        "description": "List all products, expects an array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "setup": {
            ...
            "body": {
                ...
                "description": "Product to test inventory retrieval",
                "price": 20.0
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "PUT",
        "description": "Create a product (auto-initializes inventory at 0), then update the inventory quantity to 100",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Inventory Update Product",
                "description": "Product to test inventory update",
                "price": 35.0
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}",
        "method": "PUT",
        "description": "Attempt to update inventory without the required quantity field",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Inventory Missing Field Product",
                "description": "Product to test missing field",
                "price": 12.0
            },
            "extract_id_from": "id"
        },
    ...
    },
    {
        ...
        "method": "POST",
        "description": "Create a product (inventory initialized at quantity=0, reserved=0), then attempt to reserve 5 units which exceeds available stock (0). Expects 400 insufficient inventory.",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
                "name": "Insufficient Stock Product",
                "description": "Product with no available stock",
                "price": 30.0
            },
            "extract_id_from": "id"
        },
